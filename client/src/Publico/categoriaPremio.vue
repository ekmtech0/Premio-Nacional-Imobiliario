<template>
   <NavBar/>
  <section class="border-t border-b border-t-gray-200 border-b-gray-200 p-4  lg:pt-24 lg:pb-24 mt-20" id="categoria">
...
const Categorias = ref([
  {
   titulo: 'Arquitetura Imobiliária de Excelência',
   descricao: ' Para arquitetos ou criadores de projetos imobiliários.',
   classificado: {
    vencedores:'3 vencedores:',
    primeiro: '1º',
    segundo: '2º',
    terceiro: '3º'
   }
  ...
  {
   titulo: 'Serviço Público na Habitação',
   descricao: 'Para funcionários públicos do setor da habitação',
   classificado: {
    vencedores:'3 vencedores:',
    primeiro: '1º',
    segundo: '2º',
  ...
  {
   titulo: 'Mediação Imobiliária de Referência',
   descricao: 'Para corretores ou empresas de mediação',
   classificado: {
    vencedores:'1 vencedor:',
    primeiro: '1º',
  ...
  {
   titulo: 'Prémio Especial: Sustentabilidade & Eficiência',
   descricao: '  Para quem se destacou por práticas sustentáveis',
   classificado: {
    vencedores:'1 vencedor:',
    primeiro: '1º',
